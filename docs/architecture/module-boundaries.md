...
| SMIS Agent | OpenRouter or Gemini tool-calling chat for admin/officer/teacher; first configured provider wins | Policies, Actions, all domain modules | 2026-08-15 |
