...
| SMIS Agent | Done | 100% | Feature + unit (access, tools, orchestrator, Gemini, Livewire chat) | 2026-08-17 | gemini-3.5-flash; 404/503 fallbacks |
...
- SMIS Agent needs `GEMINI_API_KEY`. Optional `GEMINI_MODEL` (default `gemini-3.5-flash`). Tests use a scripted LLM.
