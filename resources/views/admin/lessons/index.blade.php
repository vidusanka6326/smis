<x-layouts::app>
    <div class="mb-6">
        ...
        <flux:subheading>{{ __('Manage video lessons and homework across the school') }}</flux:subheading>
    </div>
    ...
    @if($lessons->isEmpty())
        <div class="rounded-xl border border-dashed border-gray-300 py-12 text-center dark:border-gray-700">
            ...
            <flux:subheading class="mt-2">{{ __('Teachers have not uploaded any video lessons yet.') }}</flux:subheading>
        </div>
    @else
                ...
                <flux:card class="flex flex-col h-full hover:shadow-lg transition-shadow">
                    ...
                    <div class="mt-4 flex items-center justify-between border-t border-gray-100 dark:border-gray-800 pt-4">
                        ...
                        <div class="flex gap-2">
                            <flux:button :href="route('admin.lessons.show', $lesson)" size="sm" variant="subtle" icon="eye" wire:navigate />
